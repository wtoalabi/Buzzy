  ...
  <div class="details__descriptions">
    <div v-for="description in descriptions" class="details__description" :id="description.id">
      <div class="description__owner">
        ...
        <router-link :to="`/user/${description.user.username}`" class="description__owner--username">
        ...
        <div class="description__owner-info">
          <span class="description__owner-info--count tag is-white" title="Total number of words authored">
            <router-link :key="likesKey" :to="`/user/${description.user.username}#words`" class="has-text-primary"><i
                class="fa fa-file-word-o mr-4"></i>{{description.user.words_count}}</router-link>
          </span>
          <span class="tag description__owner-info--count is-link" title="Total number of descriptions added">
            <router-link :to="`/user/${description.user.username}#descriptions`" class="has-text-primary"><i
                class="fa fa-comments-o mr-4"></i>{{description.user.descriptions_count}}</router-link>
          </span>
        </div>
      </div>
      <div class="description__details">
        <div class="description__icons">
          ...
          <a v-if="description.audio_file" id="audio-click-link" title="Listen to Pronounciation" class=""><i
              class="fa fa-volume-up mr-4 has-text-info"></i>Listen to pronounciation
